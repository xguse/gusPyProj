...
from gusPyCode.MDAP_proj.MD_wrappers import AceWrap
import sys

# AceWrap -> def __init__(self, optionsObj, posArgs):

optionsObj = {'kmerSize':7,
              'kmerRange':'6,9',
              'background':1,
              'ace_iter':2,} 
...
outFile    = '/Users/biggus/Documents/James/Data/DoubleBloodMeal/DBMclusterGenes.Ace.txt'
