...
col1_Vals4posOri_DnStrmReg = '2,11,12'   
col1_Vals4negOri_DnStrmReg = '2,9,10'

columns1 =  col1_Vals4negOri_DnStrmReg # (for input 1) Modify numbers to represent HUMAN column numbers for chromosome, start, and end, respectively
