...
genomeFileOne = '/Users/biggus/Documents/MBGB/Rotations/James/Data/Sequence/Aedes/aedesBdrySeqsMASKED/Aedes_Upstream_promoters.txt.masked'
genomeFileTwo = '/Users/biggus/Documents/MBGB/Rotations/James/Data/Sequence/Anopheles/anophelesBdrySeqsMASKED/Anopheles_Upstream_promoters.txt.masked'
orthologList  = open('/Users/biggus/Documents/MBGB/Rotations/James/Data/Sequence/Combo/Aaed_Agam_1-to-1.txt','r').readlines()

outFile       = '/Users/biggus/Documents/MBGB/Rotations/James/Data/Sequence/Combo/CombinedAedesAndAnophelesOrthologs.masked.fas'
...
for orthoPair in orthologList:
    ...
    if 'Yes' in [orthoPair_0_warn, orthoPair_1_warn]:
        ...
        print 'There wuias a problem with orthoPair '+str(orthoPair)+'. The following were not found in expected lists: '+str(notFoundList)
