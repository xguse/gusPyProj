...
title = 'Hist of FDRs for A1_to_m8 (1stdv,class3)'
...
filtData = filterBy(data,1,'A1_to_m8')
filtData = filterBy(filtData,2,'orthoType_3')


consHist = [eval(x[4]) for x in filtData]
medHist  = [eval(x[5]) for x in filtData]
...
binSeq = [x*0.01 for x in range(26)]
